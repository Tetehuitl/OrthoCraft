...
3. **Other Fluid Frameworks** -  Adding structure to your notes has gotten a bad rap lately. But if you know how to keep your frameworks fluid, you'll get the best of both worlds: order *and* chaos; excellent note retrieval *and* the serendipity of discovery. More on this later. <!--with fluid hierarchical structures, The LYT Framework emphasizes linking and linked frameworks.-->

### Next Steps
**A)** Read the [[Benefits of LYT Fluid Frameworks]].

**B)** Or [[Set Up Your Home Note]].
